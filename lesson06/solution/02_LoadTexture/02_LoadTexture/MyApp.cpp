...
bool CMyApp::Init()
{
	...
	{ 
		...
		{ glm::vec3(-1, -1,  1), glm::vec3(1, 1, 1), glm::vec2(0, 0) },
		{ glm::vec3( 1, -1,  1), glm::vec3(1, 1, 1), glm::vec2(1, 0) },
		{ glm::vec3( 1, -1, -1), glm::vec3(1, 1, 1), glm::vec2(0, 0) },
		{ glm::vec3(-1, -1, -1), glm::vec3(1, 1, 1), glm::vec2(1, 0) },
		{ glm::vec3(-1,  1,  1), glm::vec3(1, 1, 1), glm::vec2(0, 1) },
		{ glm::vec3( 1,  1,  1), glm::vec3(1, 1, 1), glm::vec2(1, 1) },
		{ glm::vec3( 1,  1, -1), glm::vec3(1, 1, 1), glm::vec2(0, 1) },
		{ glm::vec3(-1,  1, -1), glm::vec3(1, 1, 1), glm::vec2(1, 1) },
		{ glm::vec3( 0,  1+sqrt(2),  0), glm::vec3(1, 1, 1), glm::vec2(0.5, sqrt(3)) },
		
		{ glm::vec3(-1, -1,  1), glm::vec3(1, 1, 1), glm::vec2(0, 0) },	//KOMMENT: a ház alja mégegyszer
		{ glm::vec3(1, -1,  1), glm::vec3(1, 1, 1), glm::vec2(0, 1) },
		{ glm::vec3(1, -1, -1), glm::vec3(1, 1, 1), glm::vec2(1, 1) },
		{ glm::vec3(-1, -1, -1), glm::vec3(1, 1, 1), glm::vec2(1, 0) },
	};
	...
	m_waterTextureID = TextureFromFile("grid.bmp");
...
void CMyApp::Update()
{
	...
	m_matView = glm::lookAt(glm::vec3( 5*cosf(t),  3.5, 5*sinf(t)),		// honnan nézzük a színteret
