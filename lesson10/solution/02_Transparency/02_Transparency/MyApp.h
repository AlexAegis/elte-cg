...
protected:
	...
	//1.:
	void drawSuzanneAt( glm::vec3 at, glm::vec4 diffuse );

	//2.:
	ProgramObject		m_water_program;
	VertexArrayObject	m_water_vao;
	IndexBuffer			m_water_gpuBufferIndices;
	ArrayBuffer			m_water_gpuBufferPos;
	ArrayBuffer			m_water_gpuBufferNormal;
	ArrayBuffer			m_water_gpuBufferTex;
};
