...
protected:
	...
	//3.:
	const int kMinPointCount = 4;

	std::vector<glm::vec3>		m_controlPoints{ {-10,0,-10},{ 10,8,-5 }, { 0,4,0 }, { -8,7,5 } };
	std::vector<std::string>	m_pointName{ "Point 1", "Point 2", "Point 3","Point 4" };
	//3.:
	ProgramObject		m_splineProgram;
	const int spline_segment_count = 10;
	std::vector<glm::vec3>		m_spline;
