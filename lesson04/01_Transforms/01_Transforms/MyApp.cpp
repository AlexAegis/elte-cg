...
void CMyApp::Update()
{
	...
	m_matView = glm::lookAt(glm::vec3( 0,  0,  SDL_GetTicks() / 1000.0f),		// honnan nézzük a színteret
...
void CMyApp::Render()
{
	...
	*/
	...
	m_matWorld = glm::rotate<float>(SDL_GetTicks() / 2500.0f, glm::vec3(1.0f, 1.0f, 1.0f));
	// m_matWorld = glm::translate<float>(glm::vec3(SDL_GetTicks() / 2500.0f, 0.0f, 0.0f));
