...
bool CMyApp::Init()
{
	...
	col[3] = *new glm::vec3(0.0, 1.0, 1.0);
	col[4] = *new glm::vec3(1.0, 0.5, 1.0);
	...
	vert = new Element[8] {
		...
		{ Element(glm::vec3( 1, 1, 1), col[0],     a,    0,    1,    0, false) },
		{ Element(glm::vec3(-1, 1, 1), col[1],     a,    0,    1,    0,  true) },
		{ Element(glm::vec3( 1,-1, 1), col[2],     a,    0,    1,    0,  true) },
		{ Element(glm::vec3(-1,-1, 1), col[3],     a,    0,    1,    0, false) },

		{ Element(glm::vec3( 1, 1,-1), col[4],     a,    0,    1,    0,  true) },
		{ Element(glm::vec3(-1, 1,-1), col[5],     a,    0,    1,    0, false) },
		{ Element(glm::vec3( 1,-1,-1), col[6],     a,    0,    1,    0, false) },
		{ Element(glm::vec3(-1,-1,-1), col[7],     a,    0,    1,    0,  true) },
	};
